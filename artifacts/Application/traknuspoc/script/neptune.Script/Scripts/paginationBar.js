let paginationBar = {
    ...
    handlePagination() {
        ...
        let maxIndex = (paginationBar.pagination.count / paginationBar.pagination.take);
        ...
        let numItems = 0;
        let maxItems = paginationBar.configuration.maxNumberOfButtons - 1;
        let startItem = Number.parseInt(paginationBar.pagination.index - (maxItems / 2));
